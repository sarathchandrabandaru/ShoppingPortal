<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Mm1.aspx.cs" Inherits="Mm1" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="right-panel">
        <center>        
            <h1>Confirmation</h1>
        <h2>Grocery Item: Muffin Mixes<br />Total: $9.90</h2>
