<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Salt1.aspx.cs" Inherits="Salt1" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="right-panel">
        <center>        
            <h1>Confirmation</h1>
        <h2>Grocery Item: Salt<br />Total: $4.69</h2>
