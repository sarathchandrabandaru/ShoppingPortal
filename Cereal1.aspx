<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Cereal1.aspx.cs" Inherits="Cereal1" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="right-panel">
        <center>        
            <h1>Confirmation</h1>
        <h2>Grocery Item: Cereal<br />Total: $6.90</h2>
