<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Mm.aspx.cs" Inherits="Mm" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="right-panel">
        <center>        
            <h1>Muffin mixes</h1>
        <h2>Price: $9.90</h2>
        <h2>Sustainability Count: 765</h2>
        <h3>Availabily: yes</h3>
        <a class="btn btn-default" href="Mm1.aspx">Add to cart</a>
    </center>
</div>
    </div>
