<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Bread.aspx.cs" Inherits="Account_Bread" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="right-panel">
        <center>        
            <h1>Bread</h1>
        <h2>Price: $3.90</h2>
        <h2>Sustainability Count: 125</h2>
        <h3>Availabily: Yes</h3>
        <a class="btn btn-default" href="Bread1.aspx">Add to Cart &raquo;</a>
    </center>
</div>
    </div>
