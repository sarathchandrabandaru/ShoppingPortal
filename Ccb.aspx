<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Ccb.aspx.cs" Inherits="Ccb" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="right-panel">
        <center>        
            <h1>Chocolate cake Baked</h1>
        <h2>Price: $15.90</h2>
        <h2>Sustainability Count: 678</h2>
        <h3>Availabily: No</h3>
